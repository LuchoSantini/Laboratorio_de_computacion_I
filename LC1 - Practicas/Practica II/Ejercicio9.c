...
“Persona de altura por debajo de la media”; 
si la altura está entre 151 y 170 escriba el mensaje: 
“Persona de altura media” 
y si la altura es mayor al 171 escriba el mensaje: 
“Persona de altura por arriba de la media”
*/
...

{
    ...
    printf("Por favor, ingrese la altura de la persona en cm \n");
    scanf("%d", &alturaPersona);
